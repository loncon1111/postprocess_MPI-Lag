...
lsl_file = "test.nc"
ds = xr.open_dataset(lsl_file)
ds = ds.transpose('ntra','ntim')

# read trajectories
#traj_array = func_traj._traj_array(lsl_file)
traj_array = {var: ds[var].values for var in ds.data_vars}
...
if myrank == 0:
    ...
    dist_file = "dist_matrix_%s_%s.nc" %(cyc_name,date)
